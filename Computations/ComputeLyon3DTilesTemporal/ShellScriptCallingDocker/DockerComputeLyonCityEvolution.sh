...
j2 3dCityDBImpExpConfig.j2 DBConfig2015.yml > 3dCityDBImpExpConfig-2015.xml
...
cp -r ${1}/Lyon_2015/LYON_1ER_2015/LYON_1ER_BATI_2015_Appearance   ${1}/Lyon_2015_Splitted
...
./DockerLoad3dCityDataBase.sh citydb-full_lyon-2015 3dCityDBImpExpConfig-2015.xml ${1}/Lyon_2015_Splitted
